...
1. Clone this repository:
   git clone https://github.com/DanFSmith73/student-exam-performance.git

2. Install the required libraries:
   pip install pandas matplotlib seaborn statsmodels numpy

3. Open the notebook:
   Navigate to the notebooks folder and open blog.ipynb

4. Run all cells from top to bottom using Shift + Enter
